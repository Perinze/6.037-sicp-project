...
(define make-class-name second)
(define make-class-parent third)
(define make-class-slots fourth)
(define make-class-methods fifth)

(define method-name first)
(define method-lambda second)
  ...
  (create-class (oo-eval (make-class-name exp) env)
                ...
                (map (lambda (method)
                       (list (method-name method)
                             (oo-eval (method-lambda method) env)))
